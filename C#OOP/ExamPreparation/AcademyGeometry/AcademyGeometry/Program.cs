...
namespace GeometryAPI
{
    ...
    public class Cylinder : Figure, IAreaMeasurable, IVolumeMeasurable
    {
        ...
        public double GetArea()
        {
            ...
            double centersDistance = this.CentersDistance();
            double sideArea = centersDistance * 2d * Math.PI * this.Radius;
            return 2d * baseArea + sideArea;
        }

        public double GetVolume()
        {
            return this.CentersDistance() * Math.PI * this.Radius * this.Radius;
        }
    }
